...
namespace IdentityServer4.Quickstart.UI
{
	public class AccountService
	{
		...
		private static bool IsWindowsAuthenticationScheme(AuthenticationScheme x)
		{
			var schemeName = AccountOptions.WindowsAuthenticationSchemeName;
			return x.Name.Equals(schemeName,
