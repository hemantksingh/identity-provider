...
namespace identity
{
    public class ExternalUser
    {
	    ...
	    {
		    return Enumerable.FirstOrDefault<Claim>(_principal.Claims, x => x.Type == JwtClaimTypes.Subject)
	    ...
	    {
			var sid = Enumerable.FirstOrDefault<Claim>(_principal.Claims, x => x.Type == JwtClaimTypes.SessionId);
